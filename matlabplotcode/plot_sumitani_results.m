function plot_sumitani_results
    ...
    ref_mean_path = 'H:\dns_2026\work\work\cfd_matlab_code\1.txt';     % 平均速度文献数据
    ref_u_path    = 'H:\dns_2026\work\work\cfd_matlab_code\u+.txt';    % u_rms 文献数据
    ref_v_path    = 'H:\dns_2026\work\work\cfd_matlab_code\v+.txt';    % v_rms 文献数据
    ref_w_path    = 'H:\dns_2026\work\work\cfd_matlab_code\w+.txt';    % w_rms 文献数据
...
% 【正确三阶】包含壁面(0,0)及前3层网格，严格在 y=0 处求导
